    ...
    <div className={styles.teamMemberNames} data-scroll-to="teamMemberNames">
      <div className={styles.theTeam}>
        <div className={styles.kevin}>
          ...
          <div className={styles.kevinCard}>
          ...
          <div className={styles.heyIkBenContainer}>
            <p className={styles.heyIkBen}>
              ...
              zelf altijd al een passie gehad voor het ontwerpen en developen
              van creatieve oplossingen voor problemen, klein of groot!
            </p>
            <p
            ...
            <p className={styles.inDitTeam}>
              ...
              leven te brengen. En een zo goed mogelijk concept op te leveren
              voor onze opdrachtgever, het Erasmus MC! Ik kijk er naar uit wat
              wij als team kunnen doen om het leven van de patiënten en artsen
              toch een stukje te verbeteren!
            </p>
          </div>
        </div>
        <div className={styles.daan}>
          <div className={styles.daanChild} />
          <div className={styles.daanCard}>
          ...
          <div className={styles.hiIkBenContainer}>
            <p className={styles.hiIkBen}>
              ...
              Communication and Multimedia Design (CMD) studeer. Naast mijn
              studie ben ik ook actief in de praktijk, waar ik mijn passie voor
              UX design combineer met marketing.
            </p>
        ...
        <div className={styles.jorick}>
          ...
          <div className={styles.jorickCard}>
            <b className={styles.jorick1}>Jorick</b>
          </div>
          <div className={styles.hiIkBenContainer1}>
            <p className={styles.hiIkBen1}>
              Hi, ik ben Jorick. Student Communication and Multimedia Design
              (CMD). Naast mijn studie ben ik ook actief in de praktijk, waar ik
              voor mezelf als ZZP’er en bij een bureau werk aan mijn kwaliteiten
              als UX-Designer.
            </p>
        ...
        <div className={styles.quinten}>
          ...
          <div className={styles.quintenCard}>
          ...
          <div className={styles.heyIkBenContainer1}>
            <p className={styles.heyIkBen1}>
              ...
              Mijn passie? Het bedenken van nieuwe en interactieve
              technologische oplossingen die problemen oplossen en mensen
              inspireren.
            </p>
            ...
            <p className={styles.inOnsTeam}>
              ...
              mijn technische vaardigheden te gebruiken om innovatieve
              oplossingen te ontwikkelen.
            </p>
          </div>
        </div>
        <div className={styles.ranagul}>
          <div className={styles.ranagulCard}>
            <div className={styles.ranagulPicture} />
            <b className={styles.ranagul1}>Ranagul</b>
          </div>
          <div className={styles.hihiIkBenContainer}>
            <p className={styles.hihiIkBen}>
              ...
              technische vaardigheden combineert om visuele ontwerpen te
              creëren. Als student Communication and Multimedia Design breng ik
              mijn passie en vaardigheden samen om ideeën tot leven te brengen.
            </p>
            ...
            <p className={styles.mijnDoelIn}>
              ...
              oplossingen kan bedenken die echt van betekenis kunnen zijn voor
              de maatschappij en de werkwijze binnen Erasmus. Ik wil me vooral
              concentreren op het genereren en uitwerken van ideeën. Ik ben
              klaar voor deze uitdaging en kijk ernaar uit om zoveel mogelijk te
              leren.
            </p>
          </div>
        </div>
        <div className={styles.charlize}>
          <div className={styles.charlizeChild} />
          <div className={styles.charlizeCard}>
            <b className={styles.charlize1}>Charlize</b>
          </div>
          <div className={styles.hiIkBenContainer2}>
            <p className={styles.hiIkBen2}>
              Hi, ik ben Charlize. Student aan de Hogeschool Rotterdam waar ik
              de opleiding Communication and Multi Media Design met veel plezier
              volg. Naast mijn studie ligt mijn passie ook erg bij grafisch
              ontwerpen en ik ben sinds kort begonnen met het toepassen van mijn
              vaardigheden in de praktijk.
            </p>
            <p className={styles.blankLine7}>&nbsp;</p>
            <p className={styles.ikVindHet1}>
              Ik vind het belangrijk dat mijn ontwerpen gericht zijn op de
              wensen van de gebruiker. Op deze manier zorg ik dat mijn ontwerpen
              zo inclusief mogelijk zijn. Ook sta ik altijd open om uitdagingen
              aan te gaan waar ik wat nieuws van kan leren.
            </p>
            <p className={styles.blankLine8}>&nbsp;</p>
            <p className={styles.ikKijkUit}>
              Ik kijk uit naar de samenwerking binnen dit interdisciplinaire
              team.
            </p>
          </div>
        </div>
